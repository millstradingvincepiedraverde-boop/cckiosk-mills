...
export default function AgentPage() {
  ...
  const handleJoinRoom = async (roomId: string) => {
    ...
    try {
      ...
      // sdp filter to prefer H264/VP8 for better iOS compatibility
  ...
  // ---------- UI ----------
  // Always render a hidden local video so the ref exists before getUserMedia runs.
  // It's visually hidden when not connected, but present in the DOM.
  return (
    <div>
